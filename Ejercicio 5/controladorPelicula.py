...
class Controlador:
    ...
    def MostrarDatosPeli(self, id):
        ...
        title_label = tk.Label(details_window, text="Título: " + pelicula_detalle["title"])
        title_label.pack(pady=10)
        overview_label = tk.Label(details_window, text="Resumen: " + pelicula_detalle["overview"])
        overview_label.pack(padx=10,pady=10)
        language_label = tk.Label(details_window, text="Lenguaje original: " + pelicula_detalle["original_language"])
        language_label.pack()
        release_date_label = tk.Label(details_window, text="Fecha de lanzamiento: " + pelicula_detalle["release_date"])
        release_date_label.pack()
        genres_label = tk.Label(details_window, text="Géneros: " + ", ".join([genre["name"] for genre in pelicula_detalle["genres"]]))
        genres_label.pack()
